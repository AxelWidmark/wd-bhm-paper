...
\changes{The likelihood of the different photometric bands is calculated in flux instead of magnitudes, which is important for objects with a low signal-to-noise where a first order error propagation from flux to magnitude is inaccurate.} The likelihood associated with a WD is

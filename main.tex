...
\begin{figure*}
    ...
    \caption{Posterior density of the population parameters, for a mock data set with no astrometric information. \aw{2200 steps atm, chain is still converging.}}
    \label{fig:chain}
\end{figure*}

\begin{figure*}
	\includegraphics[width=.8\textwidth]{toy_chain_include-parallax.pdf}
    \caption{Posterior density of the population parameters, for a mock data set with parallax information. \aw{2200 steps atm, chain is still converging.}}
